...
int pari_AskDataFromServer(char *ip, int port, char *message,
                           char *server_reply, int maxChars) {
  ...
  while (strcmp(server_reply, "PASSED HERE!") != 0) {
  ...
  printf("message fully recieved\n");
  return sock; // success
}

int CreateNewMessage(int a, char *Dir1, char *Dir2, int *left, int *right,
                     char *message) {
